...
data "aws_iam_policy_document" "kubectl_admin_trust" {
  ...
  statement {
    ...
    condition {
      ...
      values = [
        "repo:cloud-platform-infrastructure/platform-infra:ref:refs/heads/main",
        ...
        "repo:cloud-platform-infrastructure/platform-infra:environment:${var.environment}",
        "repo:cloud-platform-infrastructure/deploy-workflows:environment:${var.environment}",
        "repo:cloud-platform-infrastructure/app-frontend:environment:${var.environment}",
        "repo:cloud-platform-infrastructure/app-backend:environment:${var.environment}",
      ]
    }
  }
}
